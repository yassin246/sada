...
#include "../../../src/model/LibraryScanner.h"
...
void LibraryScanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->songsFound((*reinterpret_cast<std::add_pointer_t<QList<Song>>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< QList<Song> >(); break;
            }
            break;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LibraryScanner::*)(const QVector<Song> & )>(_a, &LibraryScanner::songsFound, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LibraryScanner::*)(int , int )>(_a, &LibraryScanner::progressChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (LibraryScanner::*)(int )>(_a, &LibraryScanner::scanFinished, 2))
            return;
    }
}
...
// SIGNAL 0
void LibraryScanner::songsFound(const QVector<Song> & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void LibraryScanner::progressChanged(int _t1, int _t2)
{
